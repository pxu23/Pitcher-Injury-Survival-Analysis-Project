...
train_evaluation_seasons = [("2021", "2022"), ("2022", "2023"), ("2023", "2024")]

models = ["cox", "weibull_aft", "rsf", "gradient_boosting"]

# change to weibull_aft, rsf, gradient_boosting
for (train_season, evaluation_season) in train_evaluation_seasons:
    for model_name in models:
        ...
        threshold_age = survival_df_time_invariant_train_season["age"].quantile(0.75)
